...
import {
  ...
  NbListModule,
  NbSpinnerModule,
  NbAutocompleteModule, NbSpinnerComponent
} from '@nebular/theme';
...
import { ReportDisplayComponent } from '../../@theme/components/report-display/report-display.component';
...
@NgModule({
  ...
  providers:[NumberWithCommasPipe,ToNumberPipe],
  entryComponents:[]
})
